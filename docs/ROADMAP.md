...
- [x] Test counts after the full v0.6.x: 211 → 266 bats + 136 → 139 Go + 20 → 24 Playwright; shellcheck `-x` clean across 11 .sh files. All real-VPS validated end-to-end on `synapse-vps` (Hetzner CPX22).
